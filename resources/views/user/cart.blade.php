                        ...
                        <div class="woocommerce">
                            <form method="post" action="#">
                                <table cellspacing="0" class="shop_table cart">
                                    ...
                                    @forelse($products_cart as $product_cart)
                                        <tr class="cart_item">
                                            ...
                                            <td class="product-thumbnail">
                                                @foreach($product_cart['image'] as $image)
                                                    <a href="{{ route('product.detail', $image->product_id) }}"><img
                                                            width="145" height="145" alt="" class="shop_thumbnail"
                                            ...
                                            <td class="product-name">
                                                <a href="single-product.blade.php">{{ $product_cart['item']['product_name'] }}</a>
                                            </td>

                                            <td class="product-price">
                                                <span class="amount">{{ $product_cart['item']['unit_price'] }}</span>
                                            </td>
                                            ...
                                            <td class="product-quantity">
                                                <div class="quantity buttons_added">
                                                    ...
                                                    <input type="number" size="4" class="input-text qty text"
                                                           title="Qty" value="{{ $product_cart['quantity'] }}" min="0"
                                                           step="1">
                                            ...
                                            <td class="product-subtotal">
                                                <span
                                                    class="amount">{{ $product_cart['item']['unit_price'] * $product_cart['quantity'] }}</span>
                                            </td>
                                        </tr>
                                    @empty
                                        {{"No data"}}
