                                        ...
                                        @forelse($products as $product)
                                            <tr class="cart_item">
                                                ...
                                                <td class="product-price">
                                                    <span
                                                        class="amount">{{ $product['item']['unit_price'] }}</span>
                                                </td>
                                            ...
                                            <ul class="products">
                                                <li class="product">
                                                    ...
                                                    <a class="add_to_cart_button" data-quantity="1" data-product_sku=""
                                                       ...
                                                       href="single-product.blade.php">Select
                                                        options</a>
                                                </li>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="footer-about-us">
                            ...
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Perferendis sunt id doloribus
                                vero
                                quam laborum quas alias dolores blanditiis iusto consequatur, modi aliquid eveniet
                                eligendi
