                            ...
                            <tr>
                                <td>
                                    <div class="task-contain">
                                        ...
                                        <p class="d-inline-block m-l-20">{{ $brand->name }}
                                        </p>
                                    </div>
                                </td>
                                <td>
                                    <p class="d-inline-block m-r-20"><a href="{{ route('brands.edit', $brand->id) }}"><i class="ti-pencil"></i></a></p>
                                </td>
                                <td>
